...
st.set_page_config(page_title="AirBnb-Analysis by ARUN S!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    df = pd.read_csv(r"C:/Users/nanda/Downloads/Airbnb NYC 2019.csv", encoding="ISO-8859-1")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"ARUN S"}')
    mail = (f'{"Mail :"}  {"arunshanmugam49@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    
    col1, col2 = st.columns(2)
    col1.image(Image.open(r"C:/Users/nanda/Downloads/images-20240812T162628Z-001/flights.jpg"), width=300)
